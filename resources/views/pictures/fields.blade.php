...
<div class="row pictures">
    ...
    <div class="form-group col-sm-6 col-lg-6 mb-3">
        ...
        {!! Form::text('picture_name[]', null, ['class' => 'form-control' . ($errors->has('picture_name')?' is-invalid':''), 'required'  ]) !!}
    ...
    <div class="form-group col-sm-6 col-lg-6 mb-3">
        ...
        {!! Form::file('picture[]', null, ['class' => 'form-control' . ($errors->has('picture')?' is-invalid':''), 'required' ,'accept'=>'image/*' ]) !!}
